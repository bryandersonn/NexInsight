    ...
    <section id='product'>
      <div className='z-10 w-full bg-white py-16 px-4'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
          <img className='w-[500px] mx-auto my-4' src={Laptop} draggable='false' alt='/' />
        ...
        <div className='max-w-[1240px] flex-row-reverse  mx-auto grid md:grid-cols-2'>
          <div className='flex flex-col justify-center'>
            <p className='text-[#00df9a] font-bold '>DATA ANALYTICS</p>
            <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>Manage Data Analytics Centrally</h1>
            <p>
            Collecting, processing, and analyzing complex data sets to uncover meaningful insights and inform decision-making. 
            It involves several key stages, including data collection from various sources, 
            data processing to ensure accuracy, and statistical analysis to identify trends and patterns.
            </p>
          </div>
          <img className='w-[500px] mx-auto my-4' src={Laptop} draggable='false' alt='/' />
        </div>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
          ...
          <div className='flex flex-col justify-center'>
            ...
            <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>Data Driven Insight</h1>
            <p>
            Generating actionable knowledge from the analysis of data, 
            allowing organizations to make informed decisions based on empirical evidence rather than intuition.
            The insights generated are then translated into clear, actionable recommendations that highlight opportunities and areas for improvement.
            </p>
          </div>
        </div>
      </div>
